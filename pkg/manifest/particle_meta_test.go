...
var TestCases = map[string][]string{
	...
	"user/particle@tag-22":                    {"https://particle.m41den.dev/", "user", "particle", "tag-22"},
	"user/particle":                           {"https://particle.m41den.dev/", "user", "particle", "latest"},
	"user/particle@.2.2.":                     {"https://particle.m41den.dev/", "user", "particle", ".2.2."},
