...
var TestCases = map[string][]string{
	...
	"user/particle@tag-22":                    {"http://particles.fruitspace.one/repo/", "user", "particle", "tag-22"},
	"user/particle":                           {"http://particles.fruitspace.one/repo/", "user", "particle", "latest"},
	"user/particle@.2.2.":                     {"http://particles.fruitspace.one/repo/", "user", "particle", ".2.2."},
